...
<div class="mian" id="app">
  ...
  <el-form class="contactUs-form" ref="form" :model="form" label-width="100px" :rules="rules">
    <el-form-item label="项目类型" prop="type">
      <el-select v-model="form.type" placeholder="请选择项目类型">
        <el-option v-for="item of type" :label="item.typeName" :value="item.typeName"></el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="项目简介" prop="introduction">
      <el-input type="textarea" v-model="form.introduction" placeholder="最多输入500字"></el-input>
