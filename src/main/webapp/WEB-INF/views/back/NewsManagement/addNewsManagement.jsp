    ...
    <form action="" method="post" class="layui-form addForm">
      ...
      <div class="layui-form-item">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline" style="width: 1200px;">
            <textarea class="layui-textarea" id="content" style="display: none;" name="content"
      ...
      <div class="layui-form-item">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" value="" name="key_words" class="layui-input" lay-verify="required"/>
          </div>
        </div>
      ...
      <div class="layui-form-item">
        <div class="layui-inline">
          ...
          <input type="hidden" value="" name="img_one" id="imgUrl"/>
      ...
      <div class="layui-form-item">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" value="" name="time" id="startTime" lay-verify="required" class="layui-input"/>
          </div>
        </div>
      </div>
      <div class="layui-form-item">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" value="" name="source" lay-verify="required" class="layui-input"/>
          </div>
