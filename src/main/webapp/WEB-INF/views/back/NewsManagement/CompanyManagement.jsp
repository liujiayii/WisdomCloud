...
<jsp:include page="../Inheritance/nav.jsp"></jsp:include>
		    	...
		    	<div class="layui-body-content">
		    		<p class="ContP"><img src="/img/back/dataSj.png">新闻资讯<a href="/news/add.action" class="contp_a"><i class="layui-icon">&#xe608;</i>添加</a></p>
		    		<div class="ContDom">
...
<script type="text/javascript">
	...
	var cols=[{field: "id", title: "编号" ,align:"center" ,unresize:true },
	            {field: "type", title: "栏目" ,align:"center",unresize:true },
				{field: "title", title: "标题" ,align:"center",unresize:true},
				{field: "content", title: "内容" ,align:"center",unresize:true },
				{field: "key_words", title: "关键词" ,align:"center",unresize:true},
				{field: "source", title: "来源" ,align:"center",unresize:true },
	...
	table.on('tool(test)', function(obj){
	    ...
	    if (obj.event === 'del') {
			layer.confirm('真的删除吗', function(index){
				obj.del();
				$.post('/news/delete.action',{'id':data.id},function(){
	    		},'json');
				closeDialog();
			})
		}else if(obj.event === 'edit'){
	    	window.location.href="/news/updates.action?id="+data.id;
	    }else if (obj.event === 'detail') {
	    	var status = data.status;
			if(status == 0){
				layer.confirm('确定要下架吗？', function(index){
					$.ajax({
						url:'/news/updateStatus.action',
