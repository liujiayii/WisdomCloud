...
<div class="layui-body-content" style="border: none;">
  ...
  <div class="echartsArea">
    <p class="echartsP"><a href="javascript:;" class="echartsA echartsSelect" onclick="clickEcharts($(this))" title="1">当日</a><a
      class="echartsA" href="javascript:;" onclick="clickEcharts($(this))" title="2">近7天</a><a class="echartsA"
                                                                                               href="javascript:;"
                                                                                               onclick="clickEcharts($(this))"
                                                                                               title="3">近30天</a></p>
