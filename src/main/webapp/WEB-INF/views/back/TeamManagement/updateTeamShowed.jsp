      ...
      <form action="" method="post" class="layui-form addForm" lay-filter="formTest">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" name="name" value="" lay-verify="required" placeholder="" autocomplete="off"
                     class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-upload-list">
              <img class="layui-upload-img" id="demo2" src="" alt="选择图片" title="图片">
              <p id="demoText"></p>
            </div>
            <div class="layui-input-block imageArea">
              <p id="test2">本地上传</p>
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" value="" name="email" lay-verify="required" class="layui-input"/>
            </div>
          </div>
        </div>
        <div class="layui-form-item">
      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          if (result.code == 0) {
            ...
            $("#demo2").attr("src", result.data.group_img);
            $("#imgUrl").val(result.data.main_img)
            $("#imgUrls").val(result.data.group_img)
            // 表单初始赋值
