			    			...
			    			<form action="" method="post"class="layui-form addForm" lay-filter="formTest">
			    			    ...
			    			    <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" value="" lay-verify="required" name="imageNumber" class="layui-input" maxlength="10" readonly/>
                                        </div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" value="" lay-verify="required" name="imgPlace" class="layui-input" maxlength="50" readonly/>
                                        </div>
								...
								<div class="layui-form-item">
									<div class="layui-inline">
									    ...
									    <div class="layui-input-inline">
									    	<input type="text" value="" lay-verify="required" name="name" class="layui-input" maxlength="10" readonly/>
									    </div>
									    <div class="layui-form-mid layui-word-aux">1-10个字符</div>
									</div>
								</div>
