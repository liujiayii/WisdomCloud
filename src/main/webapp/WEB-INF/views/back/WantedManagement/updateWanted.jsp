...
<jsp:include page="../Inheritance/nav.jsp"></jsp:include>
		    	...
		    	<div class="layui-body-content">
		    		<p class="ContP"><img src="/img/back/dataSj.png">招聘修改</p>
		    		<div class="ContDom ContForm">
		    			<form action="" method="post"class="layui-form addForm" >
		    				<input type="hidden" value="${wanted.id }" name="id">
							<div class="layui-form-item">
								<div class="layui-inline">
									<label class="layui-form-label">招聘岗位</label>
								    <div class="layui-input-inline">
								    	<input type="text" value="${wanted.job }" name="job" class="layui-input"  lay-verify="required"/>
								    </div>
							...
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
								    	<input type="text" value="${wanted.wantNumber }" name="wantNumber" class="layui-input"  lay-verify="required"/>
								    </div>
								</div>
							</div>
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
								    	<input type="text" value="${wanted.education }" name="education" class="layui-input"  lay-verify="required"/>
								    </div>
								</div>
							</div>
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
								    	<input type="text" value="${wanted.major }" name="major" class="layui-input"  lay-verify="required"/>
								    </div>
								</div>
							</div>
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
								    	<input type="text" value="${wanted.workplace }" name="workplace" class="layui-input"  lay-verify="required"/>
								    </div>
								</div>
							</div>
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline" style="width: 1000px">
								    	<textarea  class="layui-textarea" id="remark" style="display: none;" name="remark" lay-verify="content">${wanted.remark }</textarea>
								    </div>
								</div>
							</div>
							<div class="layui-form-item ">
		...
		//自定义验证规则
		  ...
		  form.on('submit(add-member-submit)',function(data){
		   delete data.field.file;
	  		$.ajax({
				url:"/wanted/updateWanted.action",
