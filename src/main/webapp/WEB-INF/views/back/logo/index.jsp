    ...
    <div class="contRight">
      ...
      <div class="contForm">
        <form action="" method="post" id="fin_form" class="layui-form">
          <div class="details">
            <input type="text" name="account" value="" lay-verify="required" placeholder="请输入您的账号" class="allInput"
                   autocomplete="off"/>
          </div>
          <div class="details">
            <input type="password" name="password" value="" lay-verify="required" placeholder="密码6-12位字符含数字、字母、下划线！"
                   class="allInput" autocomplete="off" maxlength="12"/>
          </div>
          <div class="details">
            <input type="text" name="verifyCode" id="fin_code" value="" placeholder="请输入您的验证码" class="allInput"
                   style="width: 297px;float: left;" autocomplete="off"/>
