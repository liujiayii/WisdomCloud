...
<div class="layui-body-top">
    ...
    href="/color/list.action">模版色系管理</a>
	</span>
</div>
<div class="layui-body-content">
  <p class="ContP">
    <img src="/img/back/dataSj.png">模版色系管理<a href="/color/add.action" class="contp_a"><i class="layui-icon">&#xe608;</i>添加</a>
  </p>
  <div class="ContDom">
...
<script type="text/javascript">
  ...
  var cols = [{field: "id", title: "编号", align: "center", unresize: true},
    {field: "colorName", title: "色系", align: "center", unresize: true},
    {field: "remark", title: "内容", align: "center", unresize: true},
    ...
    table.on('tool(test)', function (obj) {
      ...
      if (obj.event === 'del') {
        layer.confirm('真的删除吗', function (index) {
          obj.del();
          $.post('/color/removeColor.action', {'id': data.id}, function () {
          }, 'json');
          closeDialog();
        })
      }
