...
<div class="layui-body-top">
					<span class="layui-breadcrumb">
					  	...
					  	<a href="/color/list.action">模版色系信息</a>
					  	<a href="/color/add.action">模版色系添加</a>
					</span>
</div>
<div class="layui-body-content">
  <p class="ContP"><img src="/img/back/dataSj.png">模版色系添加</p>
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" value="" name="colorName" class="layui-input" lay-verify="required"/>
            </div>
            <div class="layui-form-mid layui-word-aux">请输入色系名称</div>
          </div>
        </div>
        <div class="layui-form-item">
          <div class="layui-inline">
            <label class="layui-form-label">色系备注</label>
            <div class="layui-input-inline">
              <input type="text" value="" name="remark" class="layui-input"/>
            </div>
    ...
    form.on('submit(add-member-submit)', function (data) {
      ...
      $.ajax({
        ...
        success: function (map) {
          if (map.code == 0) {
            window.location.href = "/color/list.action";
          } else {
