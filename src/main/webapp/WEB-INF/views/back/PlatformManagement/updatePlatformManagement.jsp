		    			...
		    			<form action="" method="post"class="layui-form addForm" >
		    				...
		    				<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
										...
										<input type="text" name="companyName" value="${information[0].companyName}" lay-verify="required" placeholder="" autocomplete="off" class="layui-input"> 
							...
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
								    	...
								    	<input type="text" name="companyPhone" value="${information[0].companyPhone }" lay-verify="required" placeholder="" autocomplete="off" class="layui-input"> 
							...
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
								    	<input type="text" value="${information[0].companyAddress}" name="companyAddress" class="layui-input" lay-verify="required"/>
								    </div>
								</div>
							</div>
							<div class="layui-form-item">
							...
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
								    	...
								    	<input type="text" value="${information[0].postcode }" name="postcode" class="layui-input" lay-verify="required"/>
