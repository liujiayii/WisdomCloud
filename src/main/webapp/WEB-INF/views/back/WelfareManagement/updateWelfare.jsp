...
<jsp:include page="../Inheritance/nav.jsp"></jsp:include>
		    	...
		    	<div class="layui-body-content">
		    		<p class="ContP"><img src="/img/back/dataSj.png">公司福利修改</p>
		    		<div class="ContDom ContForm">
		    		<div class="formDemo">
		    			<form action="" method="post"class="layui-form addForm" >
		    				<input type="hidden" value="${welfare.id }" name="id">
							<div class="layui-form-item">
								<div class="layui-inline">
									<label class="layui-form-label">标题</label>
								    <div class="layui-input-inline">
								    	<input type="text" value="${welfare.title }" name="title" class="layui-input"  lay-verify="required"/>
								    </div>
							...
							<div class="layui-form-item">
								<div class="layui-inline">
								    ...
								    <div class="layui-input-inline">
								    	<textarea rows="15" cols="60" name="content" lay-verify="required">${welfare.content }</textarea>
								    </div>
								</div>
							</div>
							<div class="layui-form-item ">
		...
		//自定义验证规则
		  ...
		  form.on('submit(add-member-submit)',function(data){
		   delete data.field.file;
	  		$.ajax({
				url:"/welfare/updateWelfare.action",
