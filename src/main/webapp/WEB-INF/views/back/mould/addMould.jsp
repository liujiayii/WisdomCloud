...
<div class="layui-body-top">
					<span class="layui-breadcrumb">
					  	...
					  	<a href="/model/add.action">模版添加</a>
					</span>
</div>
<div class="layui-body-content">
  <p class="ContP"><img src="/img/back/dataSj.png">模版添加</p>
      ...
      <form action="" method="post" class="layui-form addForm">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" value="" name="modelName" class="layui-input" lay-verify="required"/>
            </div>
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" value="" name="modelPrice" class="layui-input" lay-verify="required"/>
            </div>
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <select name="colorId" id="colorId" lay-verify="required" onchange="colorName()">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <select name="tradeId" id="tradeId" lay-verify="required" onchange="tradeName()">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <select name="typeId" id="typeId" lay-verify="required" onchange="typeName()">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" value="" name="version" class="layui-input" lay-verify="required"/>
            </div>
...
<script type="text/javascript">
  ...
  var a = $("#colorId").val();
  $("#colorName opation[value='" + a + "']").attr("selected", "selected");
