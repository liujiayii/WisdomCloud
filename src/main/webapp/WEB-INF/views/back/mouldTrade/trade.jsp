...
<div class="layui-body-top">
    ...
    class="layui-icon" style="margin-right: 5px;">&#xe68e;</i>智莱云</cite></a>
				<a href="/trade/list.action">模版行业管理</a>
	</span>
</div>
<div class="layui-body-content">
  <p class="ContP">
    <img src="/img/back/dataSj.png">模版行业管理<a href="/trade/add.action" class="contp_a"><i class="layui-icon">&#xe608;</i>添加</a>
  </p>
  <div class="ContDom">
...
<script type="text/javascript">
  ...
  var cols = [{field: "id", title: "编号", align: "center", unresize: true},
    ...
    {field: "remark", title: "内容", align: "center", unresize: true, hide: true},
    ...
    table.on('tool(test)', function (obj) {
      ...
      if (obj.event === 'del') {
        layer.confirm('真的删除吗', function (index) {
          obj.del();
          $.post('/trade/removeTrade.action', {'id': data.id}, function () {
          }, 'json');
          closeDialog();
        })
      }
