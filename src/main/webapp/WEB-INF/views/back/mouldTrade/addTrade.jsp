...
<div class="layui-body-top">
					<span class="layui-breadcrumb">
					  	...
					  	<a href="/trade/list.action">模版行业信息</a>
					  	<a href="/trade/add.action">模版行业添加</a>
					</span>
</div>
<div class="layui-body-content">
  <p class="ContP"><img src="/img/back/dataSj.png">模版行业添加</p>
      ...
      <form action="" method="post" class="layui-form addForm">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            <label class="layui-form-label">模版行业名称</label>
            <div class="layui-input-inline">
              <input type="text" value="" name="tradeName" class="layui-input" lay-verify="required"/>
            </div>
            <div class="layui-form-mid layui-word-aux">请输入模版行业名称</div>
          </div>
        </div>
        <!-- <div class="layui-form-item">
          <div class="layui-inline">
    ...
    form.on('submit(add-member-submit)', function (data) {
      ...
      $.ajax({
        ...
        success: function (map) {
          if (map.code == 0) {
            window.location.href = "/trade/list.action";
          } else {
