        ...
        <ul class="layui-nav top-nav" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child child-dl"> <!-- 二级菜单 -->
              <dd class="child-dd"><a href="/login/supervisor.action">退出<img style="float: right;margin-top: 10px;"
                                                                             src="/img/back/close.png"></a></dd>
            </dl>
          </li>
        </ul>
      </div>
      <div class="static-Area">
        <button type="button" onclick='btnStatic();'>一键静态化</button>
      </div>
    </div>
  </div>
  <div class="layui-side layui-bg-black  side-scrolls">
    <div class="layui-side-scroll  side-scrolls">
      ...
      <ul class="layui-nav layui-nav-tree side-scrolls" lay-filter="test" lay-shrink="all">
        ...
        <li class="layui-nav-item">
          <a href="/type/list.action"><i class="layui-icon">&#xe620;</i>模块分类</a>
        </li>
        <li class="layui-nav-item">
          <a href="/trade/list.action"><i class="layui-icon">&#xe620;</i>模块行业</a>
        </li>
        <li class="layui-nav-item">
          <a href="/color/list.action"><i class="layui-icon">&#xe620;</i>模块色系</a>
        </li>
        <li class="layui-nav-item">
          <a href="/model/list.action"><i class="layui-icon">&#xe620;</i>模块管理</a>
        </li>
      </ul>
    </div>
  </div>
