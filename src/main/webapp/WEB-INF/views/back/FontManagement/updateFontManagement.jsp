      ...
      <form action="" method="post" class="layui-form addForm">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" value="${text.textNumber}" lay-verify="required" readonly="readonly" name="textNumber"
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" value="${text.textPlace}" lay-verify="required" readonly="readonly" name="textPlace"
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input type="text" value="${text.name}" lay-verify="required" readonly="readonly" name="name"
                     class="layui-input"/>
            </div>
            <div class="layui-form-mid layui-word-aux"></div>
          </div>
